...
#define ITEM_NAME "Rock Guitar\r (1.5x Damage)"
#define ITEM_COST 40
...
public plugin_init()
{
	...
	// Cvars Register
	cvar_rockguitar_damage_x = register_cvar("zp_rockguitar_damage_x", "4.0");
	cvar_rockguitar_clip = register_cvar("zp_rockguitar_clip", "40");
	cvar_rockguitar_bpammo = register_cvar("zp_rockguitar_bpammo", "200");
	cvar_rockguitar_shotspd = register_cvar("zp_rockguitar_shot_speed", "0.10");
...
public zp_fw_items_select_post(player, itemid)
{
	...
	client_print_color(player, "!y!gZoD *|!y You have !gbought !ya !tRock Guitar!y.");
