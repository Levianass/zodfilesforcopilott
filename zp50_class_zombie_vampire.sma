...
new const zombieclass5_name[] = "Vampire Zombie"
new const zombieclass5_info[] = "\r=Health on infection="
new const zombieclass5_models[][] = { "z_vampire" }
new const zombieclass5_clawmodels[][] = { "models/zombie_plague/zow_claws.mdl" }
const zombieclass5_health = 2000
const Float:zombieclass5_speed = 0.94
const Float:zombieclass5_gravity = 0.68
const Float:zombieclass5_knockback = 1.30
