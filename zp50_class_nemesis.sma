...
new cvar_nemesis_grenade_frost, cvar_nemesis_grenade_fire, cvar_nemesis_kill_explode2
...
public plugin_init()
{
    ...
    cvar_nemesis_kill_explode2 = register_cvar("zp_nemesis_kill_explode2", "1")
...
{	
	...
	if (flag_get(g_IsNemesis, victim))
	{
		...
		if (get_pcvar_num(cvar_nemesis_kill_explode2))
		{
	...
	if (flag_get(g_IsNemesis, attacker))
	{
