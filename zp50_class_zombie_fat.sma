...
new const zombieclass4_name[] = "Fat Zombie Baby"
new const zombieclass4_info[] = "\r=Fat="
new const zombieclass4_models[][] = { "z_fat" }
new const zombieclass4_clawmodels[][] = { "models/zombie_plague/zow_claws.mdl" }
const zombieclass4_health = 3200
