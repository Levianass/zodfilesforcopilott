...
new cvar_assassin_grenade_frost, cvar_assassin_grenade_fire, cvar_assassin_lightning_effect
...
public plugin_init()
{
	...
	cvar_assassin_lightning_effect = register_cvar("zp_assassin_lightning_effect", "1")
...
public fw_PlayerKilled(victim, attacker, shouldgib)
{
	...
	if (flag_get(g_Isassassin, attacker))
	{
		if(get_pcvar_num(cvar_assassin_lightning_effect))
		{
