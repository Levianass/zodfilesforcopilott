...
new cvar_knockback_nemesis, cvar_knockback_assassin, cvar_knockback_dragon, cvar_knockback_nightcrawler
...
public plugin_init()
{
	...
	if (LibraryExists(LIBRARY_DRAGON, LibType_Library))
		cvar_knockback_dragon = register_cvar("zp_knockback_dragon", "0.25")
	...
	if (LibraryExists(LIBRARY_NIGHTCRAWLER, LibType_Library))
		cvar_knockback_nightcrawler = register_cvar("zp_knockback_nightcrawler", "0.25")
}
